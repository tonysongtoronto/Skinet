...
export const routes: Routes = [
   ...
   {
        path: 'shop',
        loadChildren: () => import('./features/shop/routes').then(mod => mod.shopRoutes)
    },
    ...
    { path: 'cart', component: CartComponent },
      ...
      { path: 'test-error', loadComponent: () => import('./features/test-error/test-error.component')
        .then(c => c.TestErrorComponent) },
